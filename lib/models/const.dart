import 'package:googlecalculator/provider/calculator_provider.dart';
import 'package:provider/provider.dart';
import 'package:flutter/material.dart';

const backgroundColor = Color(0xFF33383f);
const buttonsBackgroundColor = Color(0xFF1f1f1f);
const yellowColor = Color(0xFFF7CF32);
const whiteColor = Colors.white;
const buttonColor = Color(0xff282a2d);
const lightBlueColor = Color(0xFF5ab3f0);
